...
public class HibernateUtil implements Serializable {
	...
	/**
	 * Responsavel por ler o arquivo de configuracao hibernata.cfg.xml
	 * 
	 * @author renato
	 */
	...
	/**
	 * Obtem a connection do provedor de conexoes configuradas
	 * 
	...
	public static Connection getConnectionProvider() {
		...
		try {
			connection = ((SessionFactoryImplementor) sessionFactory).getConnectionProvider().getConnection();
	...
	/**
	 * 
	 * @return Connection no InitalContext java:/comp/env/jdbc/datasource
	 * @throws SQLException
